...
public class ItemPickupJournalIntegration extends BaseComponentSystem {
        ...
        chapterHandler.registerJournalEntry("Exploration Log #113",
                Arrays.asList(
                        ...
                        createTextParagraph("I am certain of the fact that this planet was once home to intelligent life forms. There are clear " +
                                ...
                                "of the early civilization that existed here?<l>")
                ));
        ...
        chapterHandler.registerJournalEntry("Exploration Log- The Circle Of Life",
                Arrays.asList(
                        ...
                        createTextParagraph("The structure was gigantic and mammoth in size. A large stonehenge, so big that it’s " +
                                ...
                                "piece of witchcraft and wizardry that allowed them to stitch a hole in the fabric of space and time.<l>")
                ));
        ...
        chapterHandler.registerJournalEntry("Exploration Log- Shattered Temple of Hope",
                Arrays.asList(
                        ...
                        createTextParagraph("The tea was actually the letter T. Amidst the golden sand lay a T shaped entrance made of " +
                                ...
                                "I wonder how the portal might actually work. Would it be like my Antrum Sabre that became dysfunctional?<l>")
                ));
        ...
        chapterHandler.registerJournalEntry("Exploration Log- The Hunt for Truth",
                Arrays.asList(
                        ...
                        createTextParagraph("A Pyramid! Looks the same from all four sides. The answer was 42- " +
                                ...
                                "The treasure consisted of the Facade of Truth, one of the three elements of the portal and instructions on how to use it.<l>")
                ));

        chapterHandler.registerJournalEntry("Exploration Log #114",
                Arrays.asList(
                        createTitleParagraph("Exploration Log #114"),
                        createTextParagraph("All the items for the portal have been found. Only thing that remains is to put everything together, and fire it up.<l>")
                ));
    ...
    private void sendOverallJourneyEvent(EntityRef player) {
        ...
        List<String> lostJournalEntries = journalAccessComponent.discoveredJournalEntries.get("Lost");
        if (lostJournalEntries.contains("Exploration Log- The Circle Of Life") &&
                lostJournalEntries.contains("Exploration Log- The Hunt for Truth") &&
                lostJournalEntries.contains("Exploration Log- Shattered Temple of Hope")) {
            player.send(new DiscoveredNewJournalEntry(lostChapterId, "Exploration Log- The Circle Of Life"));
        }
    }
